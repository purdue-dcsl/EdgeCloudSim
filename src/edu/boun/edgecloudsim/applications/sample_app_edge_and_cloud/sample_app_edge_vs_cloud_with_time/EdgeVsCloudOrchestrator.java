...
public class EdgeVsCloudOrchestrator extends EdgeOrchestrator {
	...
	private int wanBW;
	public EdgeVsCloudOrchestrator(String _policy, String _simScenario, int _numDevices, int _wan_bw) {
	...
	public int getDeviceToOffload(Task task) {
		...
		if(simScenario.equals("EDGE_CLOUD_HYBRID_HOSTS_1")){
		...
		else if(simScenario.equals("ONLY_CLOUD_HOSTS_1"))
		{
			result = SimSettings.CLOUD_DATACENTER_ID;
		}
		else if(simScenario.equals("ONLY_EDGE"))
		{
			result = SimSettings.GENERIC_EDGE_DEVICE_ID;
		}
		else
