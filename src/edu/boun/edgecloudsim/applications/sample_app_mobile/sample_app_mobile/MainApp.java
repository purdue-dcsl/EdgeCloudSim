...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/sample_app_mobile/config/default_config.properties";
			applicationsFile = "scripts/sample_app_mobile/config/applications.xml";
			edgeDevicesFile = "scripts/sample_app_mobile/config/edge_devices.xml";
